...
const STRIPE_DISCORD_BOT_UNLIMITED_ANNUAL_PRICE_ID = String(process.env.STRIPE_DISCORD_BOT_UNLIMITED_ANNUAL_PRICE_ID || "price_1UB5XiGrZOEMBkuuO9ptA9mB").trim();
